...
import { DocumentReferenceDeleteDialog } from './document-reference-delete-dialog';

describe('DocumentReference Management Delete Component', () => {
  let comp: DocumentReferenceDeleteDialog;
  let fixture: ComponentFixture<DocumentReferenceDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(DocumentReferenceDeleteDialog);
