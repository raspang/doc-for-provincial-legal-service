...
import { ResponsiblePersonDeleteDialog } from './responsible-person-delete-dialog';

describe('ResponsiblePerson Management Delete Component', () => {
  let comp: ResponsiblePersonDeleteDialog;
  let fixture: ComponentFixture<ResponsiblePersonDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ResponsiblePersonDeleteDialog);
