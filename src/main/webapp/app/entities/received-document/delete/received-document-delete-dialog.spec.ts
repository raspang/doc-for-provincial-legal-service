...
import { ReceivedDocumentDeleteDialog } from './received-document-delete-dialog';

describe('ReceivedDocument Management Delete Component', () => {
  let comp: ReceivedDocumentDeleteDialog;
  let fixture: ComponentFixture<ReceivedDocumentDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(ReceivedDocumentDeleteDialog);
