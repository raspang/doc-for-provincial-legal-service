...
import { DocumentStatusDeleteDialog } from './document-status-delete-dialog';

describe('DocumentStatus Management Delete Component', () => {
  let comp: DocumentStatusDeleteDialog;
  let fixture: ComponentFixture<DocumentStatusDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(DocumentStatusDeleteDialog);
