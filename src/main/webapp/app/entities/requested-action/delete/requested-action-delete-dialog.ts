...
@Component({
  ...
  templateUrl: './requested-action-delete-dialog.html',
  imports: [FormsModule, FontAwesomeModule, AlertError],
})
export class RequestedActionDeleteDialog {
  requestedAction?: IRequestedAction;
  ...
  confirmDelete(id: number): void {
    this.requestedActionService.delete(id).subscribe(() => {
