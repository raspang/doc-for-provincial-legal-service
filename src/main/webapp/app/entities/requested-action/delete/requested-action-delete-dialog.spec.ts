...
import { RequestedActionDeleteDialog } from './requested-action-delete-dialog';

describe('RequestedAction Management Delete Component', () => {
  let comp: RequestedActionDeleteDialog;
  let fixture: ComponentFixture<RequestedActionDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(RequestedActionDeleteDialog);
