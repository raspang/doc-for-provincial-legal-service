...
describe('TransactionType Management Delete Component', () => {
  let comp: TransactionTypeDeleteDialog;
  let fixture: ComponentFixture<TransactionTypeDeleteDialog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(TransactionTypeDeleteDialog);
